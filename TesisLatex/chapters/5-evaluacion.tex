...
\subsection{Ajuste del set de datos}
...
A modo de ilustración de las diferencias de tamaño entre las imágenes realizamos un escalado proporcional que se puede apreciar en la figura~\ref{fig:imgescalas}.
